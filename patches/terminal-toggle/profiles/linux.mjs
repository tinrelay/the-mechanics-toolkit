export const linuxBuild9771Contracts = [
  ...
  "R6r=()=>{ykt.run({action:{type:`windows.terminal.toggle`,windowId:Ep}})",
  "[`toggleTerminal`,R6r]"
];
...
export const linuxBuild9647Contracts = [
  ...
  "allowWithinEditable:c,enabled:a,onKeyDown:l",
  "$wi=()=>{pen.run({action:{type:`windows.terminal.toggle`,windowId:yv}})",
  "[`toggleTerminal`,$wi]"
];
